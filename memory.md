...
- **Phase**: P7 — Hermes TUI Core Subsystem (in progress; 7.1 + 7.3 + 7.7 + 7.8 + 7.10 done)
- **Lane**: C
- **Current task**: P7 D6 - 7.4 scrollback cap + spill
- **Last completed task**: P7 7.10 safe renderer (`f0950f7`, 101 passed, render 100/100)
- **Next task**: dispatch 7.4 (single-task brief); order in docs/phase_07_implementation_plan.md
