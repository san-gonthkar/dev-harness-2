...
- **Phase**: P7 — Hermes TUI Core Subsystem (in progress; 7.1 + 7.3 + 7.4 + 7.7 + 7.8 + 7.10 done)
- **Lane**: C
- **Current task**: P7 D7 - 7.2 repo-manager panel
- **Last completed task**: P7 7.4 scrollback cap (786078f, 11 passed; slow soak deferred)
- **Next task**: dispatch 7.2 (single-task brief); order in docs/phase_07_implementation_plan.md
