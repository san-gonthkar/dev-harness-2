# Dev Harness — Memory Archive (P0–P6 execution log)

> **Append-only historical record.** Moved out of `memory.md` on 2026-09-23 to keep the
> live file small (every agent reads `memory.md` on start; this archive is read only when
> a closed phase's detail is needed). Never edit — append corrections to `memory.md`.
